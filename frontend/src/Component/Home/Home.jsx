  ...
  return (
    <div className={homestyle.mainContainer}>
      ...
      <div className={homestyle.right}>
        ...
        <p className={homestyle.intro}>
          Welcome to <br />
          <span className={homestyle.introQ}>Quest.AI</span>
        </p>
        ...
        <form className={homestyle.formData}>
          ...
          >
            {loading ? (
              <span className={homestyle.loader}></span>
            ) : (
              <span className={homestyle.loginName}>Login</span>
            )}
          </button>
        </form>

        <div className={homestyle.googleDiv}>
          <img src={google} alt="googleImage" className={homestyle.googleImg} />
          <p className={homestyle.googleName}>Continue with Google</p>
        </div>
        <p className={homestyle.noAccount}>
          Don’t have an account?{" "}
          <span className={homestyle.createAccount} onClick={routeSignup}>
            Create Account
          </span>
        </p>
      </div>
